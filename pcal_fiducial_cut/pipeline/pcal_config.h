...
struct FileConfig {
    std::string input_file = "input_data/check_pcal.root";
    std::string intermediate_file = "intermediate_data/PCAL_hist.root";
    std::string pdf_name_prefix = "output_graphs/PCAL_sector_";
};
...
struct HistogramConfig {
    ...
    std::string title_prefix = "PCAL electron";
    std::string title_suffix = "; y', cm";

    std::string title_2d_prefix = "PCAL sector";
    std::string title_2d_suffix = "; x', cm; y', cm";
};
