...
void MPPT_events_simulation_selection()
{
    // Конфигурация
    Constants mc;
    ...
    TFile* hfile =  new TFile("MPPT_events_simulation.root", "RECREATE");
    tree.Write();
    ...
    TFile* file =  new TFile("MPPT_events_simulation.root", "RECREATE");
    tree.Write();

    TFile* file2 = TFile::Open("MPPT_events_simulation.root", "READ");
    TTree* tree2 = nullptr;
    file2->GetObject("MMpiptree", tree2);
