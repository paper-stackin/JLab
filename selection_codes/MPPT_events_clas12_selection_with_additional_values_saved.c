...
void MPPT_events_clas12_selection_with_additional_values_saved()
{
    ...
    string str = "/scratch/savkin/skim30/skim30_00";
    string fin = ".hipo";
    for (int i = 5860; i <= 6000; i++)
    {
    ...
    TFile* hfile =  new TFile("MPPT_events_clas12_selection_with_additional_values_saved.root", "RECREATE");
    tree.Write();
